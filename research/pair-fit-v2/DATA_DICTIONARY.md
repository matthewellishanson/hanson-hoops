...
Phase 2B subsequently completed all 60 2023-24 pair assets, Phase 2C completed all 60 2022-23 pair assets plus two 2021-22 player assets, and Phase 2D completed all 60 2021-22 pair assets plus two 2020-21 player assets. No new raw field or semantic definition was accepted: all three releases match the approved pair contracts, and both later player-source seasons match reviewed 69-column `phase2a.player-base.v2`. Phase 2D again finds Totals `MIN` consistent with season-total minutes while Per100Possessions `MIN` is rate-normalized; neither field has an approved positive eligibility threshold or automatic role as a model feature.
