...
Phase 2B subsequently completed all 60 2023-24 pair assets, and Phase 2C completed all 60 2022-23 pair assets plus two 2021-22 player assets. No new raw field or semantic definition was accepted: both releases match the approved pair contracts, and the Phase 2C player assets match reviewed 69-column `phase2a.player-base.v2`. Phase 2C confirms that Totals `MIN` behaves consistently with season-total minutes while Per100Possessions `MIN` is rate-normalized; neither field has an approved positive eligibility threshold or automatic role as a model feature.
