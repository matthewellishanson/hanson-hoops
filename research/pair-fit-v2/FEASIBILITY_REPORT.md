...
Current status: Phase 1A through Phase 1F established the acquisition, identity, endpoint-population, and target-semantics evidence. Phase 2A/2A.1 established the historical canary and reviewed player schema. Phase 2B completed 2023-24 with 5,207 one-to-one observations, Phase 2C completed 2022-23 with 4,805, Phase 2D completed 2021-22 with 5,745, and Phase 2E completed 2020-21 through 2014-15 with 31,181. The raw 2014-15 through 2023-24 training-target window therefore has 46,938 observations and 152 preserved zero-possession rows. Its classification is `2014-15 through 2023-24 raw training window acquired with population caveats; curation planning ready`. Schema/reconciliation certifications passed, but global endpoint population exhaustiveness remains unproven and an exact-250 2020-21 Houston result is a boundary signal, not proof of omission. 2024-25 remains validation and untouched 2025-26 remains the final test. No materialization, threshold/feature selection, missing-history policy, validation split, or modeling has occurred.
