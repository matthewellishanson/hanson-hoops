...
Current status: Phase 1A through Phase 1F established the acquisition, identity, endpoint-population, and target-semantics evidence. Phase 2A/2A.1 established the historical canary and reviewed player schema. Phase 2B completed the 2023-24 raw release with 5,207 one-to-one observations; Phase 2C completed 2022-23 with 4,805; and Phase 2D completed 2021-22 with 5,745, including 5,723 positive-possession and 22 preserved zero-possession rows. Phase 2D's 2020-21 player modes reconcile at 540 IDs. Its classification is `2021-22 raw release supported with population caveats; older historical expansion ready for separate planning`. No team returned exactly 250 rows in Phase 2D, but global endpoint population exhaustiveness remains unproven. The intended training target window is now 2014-15 through 2023-24, with 2024-25 validation and untouched 2025-26 final test; older acquisition remains separately authorized. No materialization, threshold/feature selection, missing-history policy, validation split, or modeling has occurred.
